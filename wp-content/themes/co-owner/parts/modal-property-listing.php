                        ...
                        <div class="w-100 d-flex title-area">
                            ...
                            <div class="switch-top">
                                <div class="float-start form-check form-switch mt-1" <?php echo $input_disable; ?>>
                                    ...
                                    <input class="form-check-input <?php echo $input_disable_class; ?>" type="checkbox" id="enable_pool0" checked <?php echo ( $is_edit && $property->enable_pool ? 'checked' : '');?> >
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="accordion property-accordion" id="accordionExample">
                            <div class="accordion-item">
                                <form id="property-one">
                                    ...
                                    <h2 class="accordion-header" id="headingOne">
                                        <button id="action-heading-one" class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne" >
                                            STEP 1
                                        </button>
                                    </h2>
                                        ...
                                        <div class="accordion-body">
                                            ...
                                            <div class="w-100 custom-select">
                                                <select name="_pl_posted_by" class="single-select2 w-100" data-search="false">
                                                    ...
                                                    <option value="Agent">Agent/Non Owner</option>
                                                </select>
                                            </div>
                            ...
                            <div class="accordion-item">
                                <form id="property-two">
                                    <h2 class="accordion-header" id="headingTwo">
                                        <button id="action-heading-two" class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwo" >
                                            STEP 2
                                        </button>
                                    </h2>
                            ...
                            <div class="accordion-item">
                                ...
                                <h2 class="accordion-header" id="headingThree">
                                    <button id="action-heading-three" class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseThree" >
                                        STEP 3
                                    </button>
                                </h2>
                            ...
                            <div class="accordion-item">
                                ...
                                <h2 class="accordion-header" id="headingFour">
                                    <button id="action-heading-four" class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseFour" >
                                        STEP 4
                                    </button>
                                </h2>
                                                ...
                                                <div class="card text-dark bg-light">
                                                    <div class="card-body" <?php echo $input_disable; ?>>
                                                        ...
                                                        <div class="switch-top pt-3">
                                                            <div class="form-check form-switch">
                                                                <input name="_pl_enable_pool" class="<?php echo $input_disable_class; ?> form-check-input float-start" checked type="checkbox" id="enable_pool" <?php echo ( $is_edit && $property->enable_pool ? 'checked' : '');?>>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
            ...
            <div class="align-items-center d-flex row">
                ...
                <div class="col-7 col-sm-7 pb-3 px-0">
                    <div class="d-flex float-end align-items-center">
                        <a href="<?php echo empty(wp_get_referer()) ? home_url(CO_OWNER_MY_LISTINGS_PAGE) : wp_get_referer(); ?>" class="btn btn-link rounded-pill">Cancel</a>
                        <?php if(($is_edit && $property->post_status == 'publish') || ($check_for_create || $is_edit)): ?>
                            <?php if($check_for_create || $is_edit): ?>
                                <a href="#" class="btn btn-orange rounded-pill submit-co-owner-property-form"><?php echo $is_edit && $property->post_status == 'publish' ? 'Update Listing' : 'Post Listing'; ?></a>
                            <?php endif; ?>
                        <?php endif; ?>
                    </div>
                </div>
