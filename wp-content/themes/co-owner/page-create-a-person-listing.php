                    ...
                    <div class="w-100 d-flex title-area">
                        <div class="me-auto">
                            ...
                            <?php if (!$check_for_create && !$is_edit) {
                                echo '<span class="mnd-title">Please update your subscription to create more listings.</span>';
                            } ?>
                        </div>
                    </div>
                            ...
                            <form id="person-one">
                                <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne">
                                    <div class="accordion-body">
										...
										<?php if(empty($listing_status) || $listing_status == 2){ ?>
										<input type="hidden" value="create" name="_user_property_typecheck"/>
										
										<?php }else{ ?>
										<input type="hidden" value="edit" name="_user_property_typecheck"/>
										<?php } ?>
                                        <div class="row">
                                                ...
                                                <div class="w-100 custom-select">
                                                    ...
                                                    <select name="user_budget_price" class="form-control single-select2" data-search="false">
                                                        ...
                                                        <?php foreach (get_price_range_dropdown_options() as $p_value => $p_key) : ?>
														    <?php 
															   $exp_value = explode(',',$p_value);
															   
															   if(strpos($p_value, '+') !== false){
																			$compareVal=$exp_value[0];
																		} else{
																			$compareVal=$exp_value[1];
																		}															
															if($budget==$compareVal){ ?>
                                                            <option value="<?php echo $p_value; ?>" selected ><?php echo $p_key; ?></option>
															<?php }else{?>
    ...
    <div class="container">
        <div class="align-items-center d-flex row">
            <div class="col-4 col-sm-4 pb-3">
                <?php if ((empty($listing_status) || $listing_status == 2)) : ?>
                    <a href="#" class="btn btn-orange rounded-pill px-4" style="<?php echo $budget > 0 ? '' : 'display:none;' ?>;" id="person-preview-button">Preview</a>
                <?php endif; ?>
            </div>

            <div class="col-7 col-sm-7 pb-3 px-0">
                <div class="d-flex float-end align-items-center">
                    <a class="d-none submit-co-owner-person-form"></a>
                    ...
                    <?php if ($check_for_create || $is_edit) : ?>
                        <a href="#" class="btn btn-orange rounded-pill person-publish-button">
                            <?php echo (empty($listing_status) || $listing_status == 2) ? "Create Profile" : "Update Profile"; ?>
                        </a>
                    <?php endif; ?>
                </div>
            </div>
