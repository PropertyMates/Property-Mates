...
<div class="d-flex align-items-center">
    <div class="container login-main">
        ...
        <h6 class="text-center">Reset password by email.</h6>

        <h4 class="text-center">Reset Password Now</h4>

        <div class="row justify-content-center">
            <div class="col col-xxl-7 col-xl-7 col-lg-7 col-md-10">
                <div class="card login-box">
                    <div class="card-body">
                        <form id="user-reset-password" class="w-75 frm-custom pt-0" action="" method="post">
                            <div class="frm-title mt-1">
                                <h6>Reset password with email</h6>
                            </div>

                            <input type="hidden" name="token" value="<?php echo isset($_GET['token']) ? $_GET['token'] : null;?>">
                            <input type="hidden" name="email" value="<?php echo isset($_GET['email']) ? $_GET['email'] : null;?>">

                            <div class="row" id="error-block" style="display:none;"></div>

                            <div class="row reset-password-box">
                                <div class="col col-sm-12 col-12 mb-3">
                                    <input disabled type="email" class="form-control" placeholder="Email id" value="<?php echo isset($_GET['email']) ? base64_decode($_GET['email']) : null;?>" />
                                </div>
                                <div class="col col-sm-12 col-12 mb-3">
                            ...
                            <div class="row login-user-box" style="display: none;">
                                <div class="col col-sm-12 col-12 text-center pt-40px">
                                    <a href="<?php echo home_url('/login')?>" class="btn btn-orange btn-rounded w-180px">Go to Sign in</a>
                                </div>
                            </div>
                        </form>
