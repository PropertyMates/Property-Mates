<?php
	 ...
	 * The main one that is used in Starkers is CoOwner::add_slug_to_body_class(), this will add the page or post slug to the body class
	 *
	 */
	 ...
	 class CoOwner {
    	 ...
    	 * e.g. CoOwner::get_page_id_from_path('about/terms-and-conditions');
    	 *
    	 * @param 	string
    	 * @return 	integer
    	 * @author 	Keir Whitaker
    	...
    	public static function add_slug_to_body_class( $classes ) {
    		...
    		if( is_home() || is_front_page()) {
                ...
                $classes[] = 'lg-main-bg';
            } elseif( is_page(CO_OWNER_PROPERTY_LIST_PAGE) ) {
