...
<div class="center-area">
                    ...
                    <div class="title-area">
                        <h3 class="d-flex">
                            ...
                            <div class="list-btns ms-auto d-none d-md-block">
                                <div class="btn-group">
                                    <a href="<?php echo get_view_url('list'); ?>" class="btn btn-orange list <?php echo ($view_mode == 'list'?'active':''); ?>">List View</a>
                                    <a href="<?php echo get_view_url('map'); ?>" class="btn btn-orange map <?php echo ($view_mode == 'map'?'active':''); ?>">Map View</a>
                                </div>
                            </div>
                        </h3>
    ...
    <div class="main-section srt-section py-40px">
        <div class="container">
            <div class="row">
                <form action="<?php echo get_view_url($view_mode); ?>" method="get" id="property-view">
        ...
        <div class="container">
            <div class="row mt-4">
                ...
                <?php if($view_mode == 'map') : ?>
                    <div class="col-xxl-3 col-xl-4 col-md-5 col-sm-12 col-12">
                        ...
                        <?php foreach (get_co_owner_property_list(get_query_filters()) as $key => $property) : ?>
            ...
            <div class="row">
                <div class="col-md-12 mt-5">
                    <?php echo co_owner_paginate_links(); ?>
                </div>
            </div>
        </div>
    </div>
