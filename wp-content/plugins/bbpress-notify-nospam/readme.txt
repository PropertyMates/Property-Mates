...
<ul>
    ...
    <li><a href="https://usestrict.net/product/bbpress-notify-no-spam-buddypress-bridge/?utm_source=bbpnns-readme&utm_medium=web&utm_campaign=bbpnns-wp.org" target="_blank">BuddyPress Integration</a>: Notify BuddyPress Group members of new Group Forum topics and replies. It also shows individual Opt Out and Digest settings in each user's BuddyPress profile screen.</li>
