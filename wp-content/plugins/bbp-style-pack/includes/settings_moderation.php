...
function bsp_style_settings_moderation () {
	...
	<!-- checkbox to activate  -->
		...
		<tr>
			<td colspan='2'>
				<p>
					<?php _e('<strong>NOTE- </strong>Once activated the settings are in Dashboard>settings>forums - click <a href="/wp-admin/options-general.php?page=bbpress/#bsp-moderation" > here</a>', 'bbp-style-pack'); ?>
				</p>
			</td>
		</tr>
		</table>
...
<table>
	<tr>
		<td>
			<?php _e('Moderation Tools gives you more control over your forums by adding rules that can automatically detect spam from users and bots. Out of the box bbPress has limited moderation tools which means running a forum can be a constant battle to stop spam.
', 'bbp-style-pack'); ?>
		</td>
	</tr>
...
<table>
	...
	<tr>
		...
		<td colspan="2">
			<?php _e('*Approval and unapproval of posts and blocking users is handled on the front end by showing pending posts to the post author, moderators and administrators.
', 'bbp-style-pack'); ?>
		</td>
	</tr>
